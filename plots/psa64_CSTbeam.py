...
def get_aa(freqs):
    ...
    for pi in ('x','y'):
        for i in prms['antpos'].keys():
            beam = bm.prms['beam'](freqs,nside=64,lmax=20,mmax=20,deg=7)
...
#    'hyd':{ 'jys':10**2.474107, 'index':  0.668695 , },
    ...
    'zen':{'dec':'-31:43:17.5', 'ra':'21:25:41.9','jys':1}#moved 1deg south to prevent 0 crossing errors
}
...
#    custom_srcs = ['J1615-605','J1935-461','J2154-692','J2358-605']
    ...
    customs = [s for s in srcs if s in custom_srcs]
    if len(customs)>0:
        for src in customs:
