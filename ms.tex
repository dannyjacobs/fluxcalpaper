...
from neighboring sources by filtering.%XXX what kind of filtering?
...
diverges slowly with declination, with a maximum of 10\% over 5\arcdeg{} of declination range, though most are less. %XXX most what are less?
Thus, to first order,
